...
async function getStaticProps() {
    // fetch data from an API
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://cmancheta:gabaldon1@cluster0.uyoonap.mongodb.net/meetups?retryWrites=true&w=majority");
    const db = client.db();
